...
% \linenumbers  % disabled: removes per-line numbers in the margin
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.85\linewidth]{./Figures/f1_class_distribution.pdf}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.95\linewidth]{./Figures/f2_sample_per_class.pdf}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.7\linewidth]{./Figures/f9_model_comparison.pdf}
...
\begin{subfigure}{0.49\linewidth}\centering
  \includegraphics[width=\linewidth]{./Figures/f7_resnet50_confusion.pdf}
  \caption{ResNet50 confusion matrix.}
\end{subfigure}\hfill
\begin{subfigure}{0.49\linewidth}\centering
  \includegraphics[width=\linewidth]{./Figures/f8_resnet50_roc.pdf}
...
\centering
\begin{subfigure}{0.49\linewidth}\centering
  \includegraphics[width=\linewidth]{./Figures/f5_custom_cnn_confusion.pdf}
  \caption{Custom CNN confusion matrix.}
\end{subfigure}\hfill
\begin{subfigure}{0.49\linewidth}\centering
  \includegraphics[width=\linewidth]{./Figures/f6_custom_cnn_roc.pdf}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.95\linewidth]{./Figures/f10_gradcam.pdf}
...
service stays responsive. On the full-TensorFlow build the service additionally
returns a live Grad-CAM overlay and an entropy-based uncertainty estimate with
each prediction, surfacing the explainability analysis to end users at inference
time.

\begin{figure}[!ht]
\centering
\includegraphics[width=0.6\linewidth]{./Figures/f11_robustness.pdf}
...
\begin{itemize}
\item Live demo: \url{https://ashokcse-document-type-classification-framework.hf.space}
\item GitHub: \url{https://github.com/ashok-cse/PR_SE26_German_Document_Type_Classification_with_CNNs}
